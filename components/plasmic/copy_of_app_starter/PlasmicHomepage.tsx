...
// Plasmic Project: qM1hN9qCcgsy1qqy2S5wrB
// Component: sGv9AfmOZeVQ
...
import Header from "../../Header"; // plasmic-import: rFK2g4Q613nf/component
...
import projectcss from "./plasmic.module.css"; // plasmic-import: qM1hN9qCcgsy1qqy2S5wrB/projectcss
import sty from "./PlasmicHomepage.module.css"; // plasmic-import: sGv9AfmOZeVQ/css

import LeftNavigationBackSvgrepoComsvgIcon from "./icons/PlasmicIcon__LeftNavigationBackSvgrepoComsvg"; // plasmic-import: H99nHpVydDdT/icon
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__nBjy8)}
          >
            {(() => {
              const child$Props = {
            ...
            <AntdButton
              className={classNames("__wab_instance", sty.button__etenj)}
              onClick={async () => {
                const $steps = {};
          ...
          {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
            ...
            return (
              ...
              >
                ...
                <div className={classNames(projectcss.all, sty.freeBox__k5Jb8)}>
                  <div
          ...
          <AntdModal
            ...
            trigger={
              <AntdButton
                className={classNames("__wab_instance", sty.button___6UgRy)}
              >
                <div
                  className={classNames(
                    projectcss.all,
            ...
            wrapClassName={classNames({ [sty["pcls_1664HmBCHoHY"]]: true })}
          >
            {(() => {
              const child$Props = {
              ...
              return (
                ...
                >
                  ...
                  >
                    <AntdInput
                      className={classNames("__wab_instance", sty.input__o1OFz)}
                    />
                  </FormItemWrapper>
                  <FormItemWrapper
                    className={classNames(
                      "__wab_instance",
                      sty.formField__cyh3G
                    )}
                    label={
                  ...
                  <AntdButton
                    className={classNames("__wab_instance", sty.button___4KwHw)}
                    submitsForm={true}
                    type={"primary"}
                  >
                    <div
